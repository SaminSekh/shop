...
class InventoryManager {
    ...
    updateProductTypes(category, selectedType = '', targetId = 'productType') {
        ...
        const categoryTypeMap = {
            'Electronics': ['Mobile', 'Laptop', 'Tablet', 'Accessories', 'Camera', 'Audio', 'Other'],
            'Clothing': ['Jeans', 'Pant', 'Shirt', 'T-shirt', 'Dress', 'Jacket', 'Shoes', 'Other'],
            'Groceries': ['Fruits', 'Vegetables', 'Dairy', 'Bakery', 'Beverages', 'Snacks', 'Other'],
            'Stationery': ['Pen', 'Notebook', 'Paper', 'Art Supplies', 'Office Supplies', 'Other'],
