...
class POSManager {
    ...
    addToCartWithCustomPrice(productId, customPrice = null) {
        ...
        const message = customPrice !== null && customPrice !== parseFloat(product.selling_price)
            ? `${productName} added at negotiated price ₹${price.toFixed(2)}`
    ...
    updateCartTotals() {
        ...
        if (subtotalElement) {
            subtotalElement.textContent = `₹${this.cartSubtotal.toFixed(2)}`;
        }
            ...
            <div class="transaction-item">
                <div class="transaction-info">
                    <div class="transaction-header">
                        ...
                        <span class="transaction-amount">₹${parseFloat(transaction.total_amount).toFixed(2)}</span>
                    </div>
        ...
        invoiceContent.innerHTML = `
            <div class="invoice">
                ...
                <div class="invoice-totals">
                    <div class="total-row">
                        <span>Subtotal:</span>
                        <span>₹${(sale.total_amount + sale.discount_amount).toFixed(2)}</span>
                    </div>
                    <div class="total-row">
                        <span>Discount:</span>
                    ...
                    <div class="total-row pending">
                        ...
                        <span>₹${sale.pending_amount.toFixed(2)}</span>
                    </div>
                    ` : ''}
                    <div class="total-row">
