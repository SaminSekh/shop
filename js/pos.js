...
class POSManager {
    ...
    async completeSaleProcess(saleId, paymentMethod, total, saleData) {
        try {
            ...
            // Show invoice modal
            this.showInvoice(sale, invoiceItems, invoiceDeliveryCharge);
        ...
        printWindow.document.write(`
            ...
            <head>
                ...
                <style>
                    ...
                    body { font-family: 'Courier Prime', monospace; width: 80mm; margin: 0 auto; padding: 10px; color: #000; font-size: 12px; position: relative; }
