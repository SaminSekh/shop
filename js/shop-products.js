...
class ShopProductsViewer {
    ...
    async loadProducts() {
        try {
            ...
            this.products.forEach(p => { if (p.type) this.categories.add(p.type); });
    ...
    renderCategories() {
        ...
        container.querySelector('[data-cat="all"]').onclick = (e) => {
            document.querySelectorAll('.public-cat-btn').forEach(b => b.classList.remove('active'));
    ...
    handleFilter() {
        ...
        this.filteredProducts = this.products.filter(p => {
            ...
            const matchesCategory = this.selectedCategory === 'all' || p.type === this.selectedCategory;
